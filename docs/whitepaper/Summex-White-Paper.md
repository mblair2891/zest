...
**Sections** keep servers on their part of the room unless a manager grants a table. Combine tables on the lowest number. Tap a table that has an open check to see every check on that table — not Empty / Seat. Map color follows the checks.
