...
- **Scheduling per entity.** Kitchen cannot publish bar shifts and vice versa. Copy last week, then publish — drafts stay off the clock. Clock in / Clock out are PIN-pad keys, not POS login. Hours post to the shift’s entity.
