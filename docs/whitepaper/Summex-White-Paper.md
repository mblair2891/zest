...
**Sections** keep servers on their part of the room unless a manager grants a table. Combine tables on the lowest number. Tap a table that has an open check — one tap — to see every check on that table. The map is the status color and the table number. No chairs.
