...
**Revision · 19 Sep 2026** — Station update now or remind later.
Guide v2026.10.128.
...
4. Floor, sections, table status, release/accept. Floorplan editor: Booth 4-top, Booth U, Booth L (banquette shapes, not fat rectangles). Chair / stool / booth-bench marks auto-size from the fixture and seat count. Live floor uses the same artwork and sizing; status fill is the table surface. Each section can name a receipt printer and a bar printer.
