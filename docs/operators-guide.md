...
14. Printers: **two types only** — Receipt printer (guest check, pay, gift, drawer kick, pay QR) and Order printer (destination Kitchen / Bar / Expo / Window / Label, entity or all, which stations may send). Ethernet on the AP LAN. No Kitchen printer / Bar printer / Label printer type. Drawer kick on the receipt printer.
15. Offline / hybrid
