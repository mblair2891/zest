...
**Revision · 16 Sep 2026** — Hospitality printer models and raw 9100 test print.
Guide v2026.10.102.
...
14. Printers: **two types only** — Receipt printer (guest check, pay, gift, drawer kick, pay QR) and Order printer (destination Kitchen / Bar / Expo / Window / Label, entity or all, which stations may send). Make/model preset (Star SP700/SP742, Epson TM, Citizen, Bixolon, generic ESC/POS) sets emulation, paper width, cutter, port 9100. Ethernet on the AP LAN. Test print = raw bytes to IP:9100 via the LAN print agent or a paired station — never the OS print dialog. No Kitchen printer / Bar printer / Label printer type. Drawer kick on the receipt printer.
15. Offline / hybrid
