...
Proprietors: Michael Blair & Andy Baida · Product: Summex Hospitality OS
...
- v1: **Summex does not hold leases** — partner lessor funds.
...
Full interactive catalog: **Platform → Devices** in Summex SaaS (`/platform`).
