  ...
  return [
    {
      ...
      claimCode: "STMKDS",
      assignment: { operatorId: "vnd_steam", function: "bar_kds" },
    },
    {
      id: "dev_galaxy_b",
      locationId: "loc_hall",
      name: "Tablet B — Diamond House floor POS",
      type: "tablet_pos",
      status: "online",
      lastSeenAt: Date.now() - 20000,
      serial: "SAM-TAB-B-002",
      claimCode: "DIAPOS",
      assignment: { operatorId: "vnd_diamond", function: "floor_pos" },
    },
    {
      id: "dev_android_27",
      locationId: "loc_hall",
      ...
      claimCode: "DIAKDS",
      assignment: { operatorId: "vnd_diamond", function: "kitchen_kds" },
    },
    {
      id: "dev_3",
      locationId: "loc_pod",
