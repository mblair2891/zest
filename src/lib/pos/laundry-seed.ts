...
export const LAUNDRY_CATEGORIES: MenuCategory[] = [
  { id: "cat_laundry_steam", name: "Steam Distillery", sort: 0, color: "#2C4A6E", station: "bar" },
  { id: "cat_laundry_diamond", name: "Diamond House BBQ", sort: 1, color: "#9A6700", station: "kitchen" },
];
