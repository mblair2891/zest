...
const ROLE_VIEWS: Record<EmployeeRole, PosView[] | "all"> = {
  ...
  server: ["hq", "floor", "order", "takeout", "hall", "waitlist", "customers", "drink_ai", "online", "reports"],
  bartender: ["hq", "bar", "order", "takeout", "drink_ai", "customers", "inventory", "reports"],
  host: ["hq", "waitlist", "floor", "customers", "online", "reports"],
