...
export const DEMO_CATALOG: DemoCatalogEntry[] = [
  {
    ...
    tourFocus: "PIN pad 0000. Host stand seats. Server orders. Release/accept. Pay. Busser.",
  ...
  },
  {
    ...
    tourFocus: "PIN pad 0000. Host stand seats. Steam gift liability. Diamond redeem. Pay once. Busser.",
