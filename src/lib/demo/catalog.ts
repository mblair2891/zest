...
export const DEMO_CATALOG: DemoCatalogEntry[] = [
  {
    ...
    tourFocus: "PIN 0000. Hostess seats, server orders, kitchen/bar, pay, busser cleans.",
  ...
  },
  {
    ...
    tourFocus: "PIN 0000. Hostess seats. Server sends. Diamond kitchen / Steam bar. Pay once. Busser.",
