...
function locationSetup(existing?: Partial<LocationSetup>): LocationSetup {
  ...
  return {
    ...
    giftMaxLoadCents: 50000,
    giftMaxBalanceCents: 50000,
    giftMaxSellPerTxnCents: 50000,
    giftCashOutRemainder: false,
    giftHighValueManagerPin: true,
    giftHighValueCents: 20000,
    entityKyc: {
      [SUMMIT_HEARTH_OP_ID]: {
        legalName: "Hearth Kitchen LLC",
        dba: "Hearth Kitchen",
        ein: "12-3456789",
        owners: "A. Chen",
