...
export const GUIDE_CHAPTERS: GuideChapter[] = [
  ...
  },
  {
    ...
    summary: "Drawer, server closeout, tip pools, first-party gift, CRM, reports.",
    order: 7,
  },
  {
    id: "devices",
    title: "Devices & offline",
    summary: "Stations and PINs: device ∩ staff role. AP-LAN printers, offline.",
    order: 8,
  },
  {
    id: "kiosk",
    title: "Kiosk & host stand",
    summary: "Guest kiosk, waitlist, reservation check-in. Host stand: floor + waitlist; New to-go.",
    order: 9,
  },
  {
    id: "costs",
