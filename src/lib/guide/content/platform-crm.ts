  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Devices: Add device, role (order | ODS | host | kiosk), QR + short code, role change after activate, Publish. Deactivate keeps the named slot (cannot PIN). Delete removes the slot after one confirm — the tablet must scan a new code. Platform Admin and the venue billing owner can pair. Location owner / manager / Admin can delete.",
      ...
      steps(
        ...
        "Devices: Add device → order / ODS / host / kiosk. Show QR or code. Publish when the catalog is ready. Delete removes a slot; Deactivate keeps it.",
