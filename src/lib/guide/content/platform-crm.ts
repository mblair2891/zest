...
export const PLATFORM_CRM_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    visibility: "platform",
    roles: ["platform_admin"],
    keywords: ["tenant", "org", "suspend", "mrr", "directory", "the laundry", "venue settings"],
    blocks: [
      ...
      steps(
        ...
        "Click the tenant (The Laundry or any other). Venue settings open.",
        "Edit location, devices, menus, payments, QR, cash, or labor. Save.",
        "Tenants → back. The same org is still in the directory.",
      ),
      warn(
        "Tenants opens the real venue settings in place. Shared venue does not require a host merchant. Do not treat The Laundry as a demo seed.",
      ),
