...
export const PLATFORM_CRM_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        "Get pricing creates a Request. Open the account. Build and Send the quote → Sent.",
        "Prospect accepts, or Admin records accept → Accepted.",
        "Record contract (checkbox + date) → Contracted. Only then is Start onboarding enabled.",
        "CRM Start onboarding uses the same gate. Force status requires OVERRIDE plus a reason.",
