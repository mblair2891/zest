  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Floor PIN signs a person onto this station. Clock in / Clock out are their own keys on that pad (Labor). Server closeout is Cash — none of those are the same action.",
  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "Clock in / Clock out are their own keys on the station PIN pad — not Login. Completing clock does not open order entry. After Login, if you are off the clock and inside that entity’s allowed early/late window for today’s published shift, the tablet may also ask Clock in for this shift? Not now skips the punch. Outside the window there is no prompt; use Clock in on the pad. Already on the clock: no prompt. Password /login never shows this.",
