...
export const PAYMENT_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      p(
        "Open /whitepaper (also linked from the marketing footer). Print from the browser for a PDF. The markdown source lives with the product docs. Revision · 26 Oct 2026 matches Guide v2026.10.26.",
      ),
      steps(
