...
export const PAYMENT_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      p(
        "Open /whitepaper (also linked from the marketing footer). Print from the browser for a PDF. The markdown source lives with the product docs. It stays in lockstep with this guide. Revision · 5 Sep 2026 matches Guide v2026.10.43 (publish to devices; labor vs owned sales).",
      ),
      steps(
