  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Each confirm, table-ready, and opt-out counts 1 SMS against the location monthly allotment (platform default 500; location may set a lower cap). Email receipts never count.",
      ),
      steps(
        "Turn Waitlist on and pick a reason. Location settings: SMS on/off and optional lower monthly cap.",
        "Guest taps Add me to waitlist on /kiosk.",
        "Host taps Notify when a table can take them.",
        "Guest may remove via the link (that text also counts 1 SMS); staff see a waitlist notification.",
      ),
      warn(
        "At cap the house follows platform overage: bill extra at cost, block further texts, or warn only. Managers and platform are alerted at 80% and 100%. Home shows used / included / overage $ this period. Without Twilio keys, messages are sandbox-logged on the Host stand — they still count toward the allotment so a silent unlimited send cannot happen.",
      ),
