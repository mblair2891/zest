  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Counter / drive-through stay queue / window (no dining floor). Kitchen PIN on an order tablet: clock sheet + message, not the two-button POS. Unpaired: type the Devices code and submit.",
