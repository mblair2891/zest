  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Order tablet menu — My tables (full-service floor only; map + status, no side drawers). New table. To-go. Bar tab if the venue has a rail and the PIN allows it. Clock in/out. Print check and paid receipt follow the table’s section receipt printer (to-go uses the venue default). Handhelds ring and fire. Terminal (cash + drawer) kicks the receipt printer that printed that check. Closeout (server / manager, end of shift). Kitchen PIN on an order tablet: clock sheet — Clock and Done only.",
        "Host tablet menu — Floor / seat, Waitlist, To-go, Clock in/out. No sale when this stand is bound to a Receipt printer. No ODS rail, no menu editor, no bar tab on this menu.",
