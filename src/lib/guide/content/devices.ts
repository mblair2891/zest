  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "APK updates (new Summex Station binary): Exit kiosk stops lock-task and shows Android home (or the PIN pad if the station stays open). If the signed-in person is not a manager, Exit kiosk asks for the manager, owner, or Devices service PIN, then leaves. A staff PIN does not exit. Long-press reload (2 seconds) uses the same PIN rule.",
      ),
      ul(
        ...
        "Exit kiosk = leave lock-task and return to Android home or the PIN pad. The button is always on the station shell. Manager / owner / supervisor confirm and exit. Anyone else must enter the manager or Devices service PIN first. Staff PINs cannot exit.",
