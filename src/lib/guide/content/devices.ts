  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Order tablet — full service opens Floor, Checks, Menu, Pay. The map is status color and the table number, no chairs. To-go, bar tab, clock, and closeout are under Checks. Print check follows the table’s section receipt printer. Handhelds ring and fire. Terminal cash kicks the receipt printer that printed that check. Kitchen PIN: Clock and Done only. Counter is New ticket. Drive-through is the lane.",
        "Host tablet — Floor, Checks, Menu, Pay. Waitlist, To-go, and Clock are under Checks. No sale when this stand is bound to a Receipt printer. No ODS rail, no menu editor, no bar tab on this tablet.",
