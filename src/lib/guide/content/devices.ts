  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Devices: Deactivate keeps the named slot (cannot PIN; pair token dead). Unpair / Replace keep the name if you still want that station. Delete removes the slot — confirm “Delete this device. The tablet must scan a new code.” An online tablet returns to the pair-code field. Location owner / manager / Admin only. Floor PINs cannot delete. After delete, Add device can reuse the same name and role.",
      ),
      steps(
