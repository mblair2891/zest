  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "Save. On a paired Android station, fire / Test print / receipt build ESC/POS (Star SP700 or generic) and write raw bytes to IP:9100 from the native shell. The WebView is HTTPS and cannot TCP 9100 to the house LAN. Laptop Chrome uses a registered print agent; otherwise “Use a paired station or print agent.” Never the OS print dialog (no Brother laser popup).",
      ),
      ul(
