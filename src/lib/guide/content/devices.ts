  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Host: floor + waitlist/seat. Seat the room from the map.",
        ...
        "Server / bartender / cashier PIN → order or host as this location allows. Bartender may also run a bar ODS tablet.",
