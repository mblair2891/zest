  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "POC opens /tenant/…, sets a password, completes the wizard, submits.",
        "Host sees status complete. Host still owns routing and payouts. Tenant cannot change host billing or other tenants.",
      ),
