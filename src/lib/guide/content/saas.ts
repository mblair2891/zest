  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "Locations — one or more sites and the operating model (single operator vs host + tenants vs shared venue). Shared venue and host + tenants get a unique venue slug from the name (editable before publish).",
        ...
        "Hardware — ship-to and quantity of Finix/Quantum readers (required for live cards). Staff stations are Android tablets with Summex Station. Printers and drawers stay BYO. Training/sandbox can run without a physical reader.",
