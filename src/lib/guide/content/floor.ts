  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Reset table numbers asks, then numbers dining tables and booths from 1, from the top of the room and left to right. A booth that already uses a B number stays out of that sequence. Each stool stays its own capsule outside the bar, on the guest side. That bar’s stools become B1, B2, and so on, walking each leg from the end a guest sits first. The digits stay upright. BAR, or the bar’s own name, stays on the longest leg. B numbers are not written along the slab.",
