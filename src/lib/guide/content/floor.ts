...
export const FLOOR_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    keywords: ["floor editor", "copy", "drag", "resize", "booth", "booth 4-top", "U booth", "L booth", "barstool", "layout", "room", "chair", "seating", "how many", "reset table numbers", "grid", "ruler", "snap", "align"],
