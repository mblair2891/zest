  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "Return to Floor on an order or host tablet. The editor and the live floor are a white workspace. Walls, doors, and windows sit where you drew them; on the live floor they are a hairline, and the host stand stays a block. The bar is a gray slab so the rail stays visible. A house name can sit small on the line. Empty dining tables are hairline rings with a medium-weight number inside and a few seat nubs. Any other status fills the circle or rounded square and keeps those nubs. Square no seats has none. Stool tiles use that same thin ring. Publish writes the full layout, so the editor and the live map show the same pieces.",
      ),
      tip(
