  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Reset table numbers asks which set to renumber. Tables and booths only is the default: dining tables and booths become 1 through N from the top of the room, left to right, and a booth that already uses a B number stays out of that sequence. Bar numbers and the bar itself stay as they are. Barstools only relabels the stool capsules B1, B2, and so on along each rail, from the end a guest sits first. Those digits stay upright on the capsule. Tables stay as they are, and B numbers are not written on the slab. Both does the two together. Cancel changes nothing.",
