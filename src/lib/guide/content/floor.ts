  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Select a bar top and set Stools. A straight bar or an island takes one count. An L asks for leg A and leg B, with a corner seat that stays off until you check it. A U asks for left, rear, and right. Generate places hollow rings on the guest side of the black rail, facing the bar, about 2 in clear of the stroke. They are not on the wood and not on the centerline. Generate again asks before it replaces stools already on that bar. After that you can still drag a stool; it snaps against the rail, not onto it.",
