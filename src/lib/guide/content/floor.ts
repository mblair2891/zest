  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Place table, Booth 4-top, Booth U, Booth L, barstool, wall, door, window, host stand, bar top, or other. Icons match the plan shape. Drag to move. Corner handle resizes. Walls snap and stretch by length. Bar top shape is Straight, L, U, island, or a custom polyline. The bar selects on the wood slab. A click on open floor beside an L or U leaves the bar unselected. Each leg has an end handle: drag it to lengthen or shorten that leg, and the corner stays put. A straight bar has a handle at each end of the long axis. Stool pills stay on the rail as a leg changes. Publish stores each leg’s length. Rotate 90° turns the selected piece and its handles together, 0→90→180→270→0, around its center and saves that angle. A wall, door, or window keeps a black end handle on each new end. Drag that handle and the piece lengthens along that direction. The selection outline follows the rotated piece. Tables, booths, and bar-leg handles use the same spin. Booth L/U and bar L/U use that angle on the live map.",
