  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Vendor operator / Entity admin — password login to that brand’s dashboard (menu, costs, schedule, reports, 86, staff PINs). Own slice only. Peer menus view-only on the floor unless the venue grant allows selling them. Cannot edit the other brand’s menu, payout, or labor.",
        "Host owner/manager (host + tenants) — password login with full access to every tenant’s ops: Devices, floor, all entity menus, reports, costs, labor, payments split, grants. Never the PIN pad.",
        "Location / venue admin (shared venue) — Devices, floor, QR, printers, Publish. Not a landlord merchant. No host role.",
