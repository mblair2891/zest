...
export const ROLE_GUIDE_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      related("type-restaurant", "type-food-hall", "host-capture", "recipes-prep", "hr-staff-basics"),
    ],
  }),
  topic({
    id: "role-kitchen-bar",
  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "PIN ≠ clock ≠ closeout. The pad logs you into the station. Clock in / out is Labor. Server closeout is Cash. Signing out of POS does not punch you out.",
