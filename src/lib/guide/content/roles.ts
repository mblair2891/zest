...
export const ROLE_GUIDE_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        "Host, supervisor, or manager PIN: short menu — Floor / seat, Waitlist, To-go, Clock in/out.",
  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        "PIN in on an order station. Full-service menu: My tables, New table, To-go, Bar tab (if the house has a rail), Clock, Closeout. Counter is New ticket. On an 8\" handheld the item menu is full width; tap Check for the slide-over.",
