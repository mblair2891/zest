...
export const ROLE_GUIDE_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        "Host, supervisor, or manager PIN: Floor, Checks, Menu, Pay. Waitlist, To-go, and Clock in/out are under Checks → Other jobs. No sale when this host stand is bound to a Receipt printer.",
        ...
        "Kitchen / cook PIN on a host tablet: Clock and Done only. No to-go.",
  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "Pay when the house allows. Closeout is under Checks → Other jobs at end of shift — not clock-out.",
      ),
  ...
  topic({
    ...
    blocks: [
      ...
      steps(
        ...
        "If you PIN an order or host tablet by mistake: Clock and Done only, then use the kitchen display.",
      ),
      warn(
  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "PIN ≠ clock ≠ closeout. Login, Clock in, and Clock out are three keys on the station PIN pad. Login opens the station. Clock in / Clock out punch Labor and do not open order entry. After Login, if you are off the clock and inside that entity’s allowed clock-in window for today’s published shift, a prompt also offers Clock in for this shift? — Clock in or Not now. Outside the window: no prompt; use Clock in on the pad. Already on the clock: no prompt. Password login never shows it.",
      ...
      steps(
        ...
        "Clock in from Clock in on the PIN pad (your PIN, not a login). Completing clock does not open order entry. After Login, you may also accept Clock in for this shift? when you are inside the window. Not now does not punch.",
  ...
  topic({
    ...
    blocks: [
      ...
      ul(
        ...
        "Clock in / Clock out are PIN-pad actions, separate from POS login. Hours post to the entity on the shift.",
      ...
      steps(
        ...
        "Staff: PIN pad → Clock in / Clock out. Hours land on the shift’s entity. Kitchen pad cannot punch a bar shift.",
      ),
