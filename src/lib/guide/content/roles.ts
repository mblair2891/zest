...
export const ROLE_GUIDE_TOPICS: GuideTopic[] = [
  ...
  topic({
    ...
    chapterId: "roles",
    title: "Host stand",
    summary: "Short menu: Floor / seat, Waitlist, To-go, Clock. Not server till close.",
    ...
    blocks: [
      ...
      ul(
        "Host, supervisor, or manager PIN: short menu — Floor / seat, Waitlist, To-go, Clock in/out. No sale when this host stand is bound to a Receipt printer.",
      ...
      steps(
        "PIN in on a host station. Pick Floor / seat, Waitlist, or To-go — not a dashboard of tiles.",
        "Seat from the map. The map is status only; the check opens after a table tap.",
