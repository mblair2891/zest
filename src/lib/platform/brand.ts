...
/** Stored Better Auth email for the bootstrap admin. Not a secret. */
export const PLATFORM_ADMIN_EMAIL = "admin@summex.local";
export const CHARGEBACK_FEE_CENTS = 3500;
