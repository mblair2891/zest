...
export function VenueRegBanner({ onReview }: { onReview?: () => void }) {
  ...
  const review = () => {
    useTaxSuggestionStore.getState().setSuggestion(top.id, top.suggestedTax);
    onReview?.();
    setView("settings");
  };
  ...
  return (
    ...
    >
      ...
      <p className="mt-0.5 text-xs text-muted-foreground">
        ...
        . Tax rates do not change until you Save.
      </p>
      <div className="mt-2 flex flex-wrap gap-2">
        <Button type="button" size="sm" onClick={review}>
          Review rates
        </Button>
