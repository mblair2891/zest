...
const MATRIX: { domain: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Realtime staffing cut/hold/add recs (never auto clock-out)",
      "Server/bartender end-of-shift closeout (not clock-out)",
      "Blind till close (count first; no paper form) + mix-based tip-out recommendations",
      "In-shift till-to-till cash transfer (no manager required)",
